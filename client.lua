...
local function getRPData()
  ...
  if frameworkName == 'qb' and QBCore then
    ...
    if playerData.money then
      cash = playerData.money.cash or localState.cash or 0
      bank = playerData.money.bank or localState.bank or 0
    else
    ...
    if playerData.job then
      job = playerData.job.label or playerData.job.name or job
